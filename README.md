...
- **1500+ Problems Solved on LeetCode** | Global Contest Rank: **Top 8%**  | Contest Rating: 1786 (max till now)
- Newbie @Codeforces  
...
#### Concepts:
`DSA` `OOPS` `DBMS` `OS` `CN` `SDLC` `Agile` `Low Level Design` `High Level Design`
